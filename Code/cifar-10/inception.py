...
def main(_):
    data = ld_cifar()
    base_model = tf.keras.applications.InceptionV3(include_top=False, weights='imagenet', input_shape=IMG_SHAPE)
    ...
    if FLAGS.train_new:
        ...
        model.save_weights("./cifar-10/weights/inception_weights", save_format="tf")
    else:
        model.load_weights("./cifar-10/weights/inception_weights")
